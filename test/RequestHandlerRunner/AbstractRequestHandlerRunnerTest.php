...
abstract class AbstractRequestHandlerRunnerTest extends TestCase
{
    /**
    ...
    /**
     * Whether or not to skip the test suite
     *
     * If tests cannot run (e.g., wrong laminas-httphandlerrunner version), this
     * method should call markTestSkipped().
     */
    abstract public function determineWhetherOrNotToSkipRequestHandlerRunnerTests(): void;

    public function setUp(): void
    {
        $this->determineWhetherOrNotToSkipRequestHandlerRunnerTests();
    ...
    public function testConstructorRaisesExceptionWhenMasterPidIsNotZero(): void
    {
        ...
        new $requestHandlerRunnerClass($httpServer, $this->dispatcher);
    }
